...
(function ($) {
    ...
    if ($loader.length) {
        $loader.delay(50).fadeOut('noraml', function () {
    ...
    $(document).on('click', 'ul.faq-list li .q', function(event) {
        $(this).closest('li').toggleClass('current');
        $(this).closest('li').find('.a').slideToggle('100');
    });

    $("#help-js").on("click","a", function (event) {
