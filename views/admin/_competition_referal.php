<?php require_once(ROOT . "/views/admin/layouts/_header_adm.php"); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="button-list">
                            <a class="btn btn-lighten-info" href="/admin/competition/invest">Конкурсы инвесторов</a>

                            <a class="btn btn-secondary" href="/admin/competition/referal">Конкурсы рефералов</a>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="mt-0 header-title mb-3">Завершенные конкурсы рефералов</h4>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="mt-0 header-title mb-3">Текущий конкурс рефералов</h4>
