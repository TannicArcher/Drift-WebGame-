                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="button-list">
                            <a class="btn btn-lighten-info" href="/admin/deposits">История покупок</a>

                            <a class="btn btn-secondary" href="/admin/deposits/days">История покупок по дням</a>
                        </div>
                    </div>
            ...
            <div class="card-box">
                ...
                <div class="table-responsive responsive-table-plugin">
                    <table class="table mb-0">
                        ...
                        <tbody>
                        <?php foreach($days_deposits as $date => $sum) : ?>

                            <tr class="htt">
                                <td><b><?=$date; ?></b></td>
                                <td><?=$days_deposits[$date]; ?> шт.</td>
                            </tr>
