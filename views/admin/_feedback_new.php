                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="button-list">
                            <a class="btn btn-lighten-info" href="/admin/feedback">Одобренные отзывы</a>

                            <a class="btn btn-secondary" href="/admin/feedback/new">Новые отзывы</a>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="" method="POST">
                                        ...
                                        <button type="submit" name="delete" class="btn btn-lighten-success waves-effect btn-xs  width-md">Одобрить</button>
                                        <button type="submit" name="acept" class="btn btn-lighten-danger waves-effect btn-xs  width-md">Отклонить</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
