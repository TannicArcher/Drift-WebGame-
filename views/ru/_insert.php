...
<div class="dt-content">
    ...
    <div class="row">
        ...
        <?php foreach ($paysystems as $paysystem) : ?>
            ...
            <?php if ($paysystem['active_insert'] == 0) continue; ?>
...
<?php if (count($last_inserts) > 0) : ?>

    <div class="col-lg-10 offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title racetabletitle"><i class="fa fa-list-ul"></i> Ваши последние пополнения</h3>
            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Сумма пополнения</th>
